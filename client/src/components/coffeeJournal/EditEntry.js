...
const EditEntry = ({ entry, handleChange, updateEntry, setEditing }) => {
  return (
    ...
    <div className="w-full block h-full bg-white">
      ...
      <div className="bg-white dark:bg-gray-800 w-full p-4 grid grid-cols-5 grid-rows-3 h-1/2 border text-center font-Roboto gap-y-4">
        ...
        <div className="col-start-2 col-end-2">
          <input onChange={handleChange} className="text-gray-800 dark:text-gray-300 font-light text-md" placeholder='change method?' type='text' name='brew' />
        </div>
        <div className="col-start-4 col-end-4">
          <input onChange={handleChange} className="text-gray-800 dark:text-gray-300 font-light text-md" placeholder='change score?' type='text' name='score' />
        </div>

        {/* bottom row */}

        <div className="row-start-3 col-span-5 text-center">
          <textarea onChange={handleChange} className="text-gray-800 dark:text-gray-300 font-light text-md" placeholder='change notes?' type='text' name='notes' />
        </div>
      </div>

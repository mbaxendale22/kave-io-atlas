...
const Description = ({ description, price, url }) => {
  return (
    <div className=" text-gray-700  text-justify overflow-x-scroll text-xs sm:text-sm w-full h-full p-4 flex flex-col justify-center items-center sm:gap-16 font-Roboto sm:shadow-md text-contrast">
